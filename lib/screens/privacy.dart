...
If you have questions or comments about your privacy rights, you may email us at [the.carbon.conscious.traveller@gmail.com](mailto:the.carbon.conscious.traveller@gmail.com).
...
If you have questions or comments about this notice, you may email us at [the.carbon.conscious.traveller@gmail.com](mailto:the.carbon.conscious.traveller@gmail.com).
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: MarkdownBlock(
                    data: privacyMarkdown,
                    config: MarkdownConfig(configs: [
                      PConfig(textStyle: const TextStyle(fontSize: 14)),
                      H1Config(style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                      H2Config(style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                      H3Config(style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                    ])),
              ),
            ),
